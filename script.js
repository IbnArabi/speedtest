...
class SpeedTest {  
  ...
  startGame() {
    ...
    this.setTitle('GO GO GO GET ON WITH IT!');
    this.startTimer();
  };
  stopGame() {
    ...
    let newTitle = `You made it! ✨ It took ${timeString} seconds! Try again to beat that score!`;
  ...
  restartGame() {
    ...
    athis.letterContainer.removeChild(letterElements[i]);
    }
